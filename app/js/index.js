      ...
      const card = `
        <article>
          <div class="text">
            <h3>${title}</h3>
            <p>${description}</p>
            <a href="${url_anime}" target="_blank" >Acesse a página</a>
          </div>
        </article>
      `
...
/**A função vai certificar que caso dois chunks cheguem em uma única transmissão
...
// elementos do html, que contem essas classes 
const [
  start,
  stop,
  cards
